...
func init() {
	mochibridge.RegisterFunc("github.com/overcyn/mochi/examples/imageview New", func() *view.ViewController {
...
func (v *ImageView) Build(ctx *view.Context) *view.Model {
	...
	chl := imageview.NewURLImageView(ctx.Get(8))
	chl.Painter = &paint.Style{BackgroundColor: internal.CyanColor}
