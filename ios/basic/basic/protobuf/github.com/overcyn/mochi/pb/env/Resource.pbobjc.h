 ...
 **/
@interface MochiPBEnvResourceRoot : GPBRootObject
@end

#pragma mark - MochiPBEnvResource

typedef GPB_ENUM(MochiPBEnvResource_FieldNumber) {
  MochiPBEnvResource_FieldNumber_Path = 1,
};

@interface MochiPBEnvResource : GPBMessage
