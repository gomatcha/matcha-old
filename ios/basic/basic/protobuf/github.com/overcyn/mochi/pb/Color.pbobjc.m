...
#pragma mark - MochiPBColorRoot

@implementation MochiPBColorRoot
...
#pragma mark - MochiPBColorRoot_FileDescriptor

static GPBFileDescriptor *MochiPBColorRoot_FileDescriptor(void) {
  // This is called by +initialize so there is no need to worry
  // about thread safety of the singleton.
  static GPBFileDescriptor *descriptor = NULL;
  if (!descriptor) {
    GPB_DEBUG_CHECK_RUNTIME_VERSIONS();
    descriptor = [[GPBFileDescriptor alloc] initWithPackage:@"mochi"
                                                 objcPrefix:@"MochiPB"
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[MochiPBColor class]
                                     rootClass:[MochiPBColorRoot class]
                                          file:MochiPBColorRoot_FileDescriptor()
                                        fields:fields
