...
//go:generate bash -c "( cd $GOPATH/src && protoc --go_out=. github.com/overcyn/matcha/pb/view/tabnav/*.proto )"
...
//go:generate bash -c "( cd $GOPATH/src && protoc --objc_out=github.com/overcyn/matcha/ios/basic/basic/protobuf github.com/overcyn/matcha/pb/view/tabnav/*.proto )"
